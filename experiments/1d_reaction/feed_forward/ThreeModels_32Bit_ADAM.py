...
from pinnsform.model import PINN, FLS, FLW, FLW2
...
if __name__ == '__main__':
    ...
    for j, model_class in enumerate(MODELS):
        ...
        for init_seed in INIT_SEEDS:
            ...
            base_model = model_class(in_dim=2, hidden_dim=512, out_dim=1, num_layer=4, seed=init_seed).to(device)
            ...
            with open(os.path.join(seed_folder_name, "trained_parameters.txt"), "w") as text_file:
