...
class WaveActDen(nn.Module):
    def __init__(self):
        super(WaveActDen, self).__init__() 
...
class EncoderLayer(nn.Module):
    def __init__(self, d_model, heads):
        ...
        self.act1 = WaveActDen()
        self.act2 = WaveActDen()
...
class PINNsformerDegen(nn.Module):
    def __init__(self, d_out, d_model, d_hidden, N, heads):
        super(PINNsformerDegen, self).__init__()
